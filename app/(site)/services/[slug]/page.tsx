...
export default function ServicePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main>
      {/* ΓöÇΓöÇ PageHero with real service photo ΓöÇΓöÇ */}
      <PageHero
      ...
      {/* ΓöÇΓöÇ By the Numbers strip ΓöÇΓöÇ */}
      <section
        style={{
      ...
      {/* ΓöÇΓöÇ Editorial intro ΓÇö 2-col when service has gallery images ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Before / After slider (only if service has before/after images) ΓöÇΓöÇ */}
      {service.beforeAfter && (
        <section className="rsp-pad" style={{ backgroundColor: COLORS.plaster }}>
      ...
      {/* ΓöÇΓöÇ Process: vertical step track ΓöÇΓöÇ */}
      <section
        className="rsp-pad"
        style={{
      ...
      {/* ΓöÇΓöÇ What's Included: grouped checklist on dark ΓöÇΓöÇ */}
      <section
        className="rsp-pad"
        style={{
      ...
      {/* ΓöÇΓöÇ Related Services ΓöÇΓöÇ */}
      {related.length > 0 && (
